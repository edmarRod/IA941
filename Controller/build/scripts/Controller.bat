...
set CLASSPATH=%APP_HOME%\lib\Controller.jar;%APP_HOME%\lib\json-20160212.jar;%APP_HOME%\lib\ws3d-proxy-0.0.1.jar

@rem Execute Controller
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONTROLLER_OPTS%  -classpath "%CLASSPATH%" Controller.Main %CMD_LINE_ARGS%
